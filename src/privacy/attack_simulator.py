...
class AttackReport:
    ...
    overall_vulnerability: str = "unknown"  # "safe", "moderate", "vulnerable", "critical"
...
class AttackSimulator:
    ...
    def run_all(self) -> AttackReport:
        ...
        if np is None or pd is None:
            return AttackReport(summary="numpy/pandas required for attack simulation")
    ...
    def _model_inversion_attack(self) -> AttackResult:
        ...
        try:
            ...
            return AttackResult(
                attack_name="Model Inversion",
                success=False, success_rate=0.0, severity="low",
                description="Linear model fitting failed."
            )
