...
function renderSynthetic(forceRender){
  ...
  /* log.debug( */ (void 0) && ('[AutoMate] rendering synthetic tab');
  ...
  if(!pb){ log.error('renderSynthetic: missing element #preview-body'); return; }
  ...
  /* log.debug( */ (void 0) && ('[AutoMate] renderSynthetic — samples:', allSamples.length, 'force:', !!forceRender);
