    ...
    *,
    ...
    for col in numeric_cols:
        ...
        if len(non_null):
            ...
            nb.min = float(desc.get("min"))
            nb.max = float(desc.get("max"))
            nb.mean = float(desc.get("mean"))
            nb.std = float(desc.get("std")) if not math.isnan(float(desc.get("std", float("nan")))) else 0.0

            nb.q01 = float(desc.get("1%"))
            nb.q05 = float(desc.get("5%"))
            nb.q25 = float(desc.get("25%"))
            nb.q50 = float(desc.get("50%"))
            nb.q75 = float(desc.get("75%"))
            nb.q95 = float(desc.get("95%"))
            nb.q99 = float(desc.get("99%"))
